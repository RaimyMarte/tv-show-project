...
import { Carousel, Footer, Loading, Navbar } from "../components"
...
export const SeriePage = () => {
  ...
  const { name, description, start_date, status, genres, rating, rating_count, network, country, image_path, pictures } = !!tvShow && tvShow
